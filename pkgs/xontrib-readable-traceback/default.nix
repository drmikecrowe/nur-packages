{
  ...
  backtrace = python3.pkgs.buildPythonPackage rec {
    ...
    meta = {
      ...
      description = "[how-to](https://github.com/drmikecrowe/nur-packages) Makes Python tracebacks human friendly";
    };
    prePatch = ''
      touch LICENSE
    '';
...
in
  python3.pkgs.buildPythonPackage rec {
    ...
    meta = {
      ...
      description = "[how-to](https://github.com/drmikecrowe/nur-packages) Make traceback easier to see for xonsh.";
    };
